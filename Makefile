...
FILES=src/main.o src/tesseract.o src/controls.o src/more.o src/config.o src/gpuprogram.o src/noise.o src/world.o
...
src/main.o: src/tesseract.h src/controls.h src/config.h src/gpuprogram.h src/vertShader.h src/fragShader.h src/noise.h src/gl.h src/world.h
...
src/world.o: src/world.h src/gl.h
