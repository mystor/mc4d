...
FILES=src/main.o src/tesseract.o src/more.o src/config.o src/gpuprogram.o src/noise.o src/world.o src/roundworld.o src/project.o src/gl.o src/readpng.o
